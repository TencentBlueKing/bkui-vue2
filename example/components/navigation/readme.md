      ...
      <template slot="footer">
        <footer class="monitor-navigation-footer">
          <div class="footer-link">
            <a href="javascript:void(0)">技术支持</a> | <a href="javascript:void(0)">社区论坛</a> | <a href="javascript:void(0)">产品官网</a>
          </div>
          <div>Copyright © 2022 Tencent BlueKing. All Rights Reserved. V1.1.1</div>
        </footer>
      </template>
    </bk-navigation>
  </div>
